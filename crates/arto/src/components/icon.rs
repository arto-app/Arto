...
impl fmt::Display for IconName {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let name = match self {
            ...
            IconName::Aperture => "aperture",
            IconName::ApertureOff => "aperture-off",
            ...
            IconName::Link => "link",
            IconName::ListDetails => "list-details",
            IconName::Markdown => "markdown",
            IconName::MessageReport => "message-report",
            IconName::Moon => "moon",
            ...
            IconName::Vocabulary => "vocabulary",
